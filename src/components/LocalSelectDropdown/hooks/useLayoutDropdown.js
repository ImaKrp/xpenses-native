    ...
    const getPositionIfKeyboardIsOpened = () => {
      if (keyboardHeight) {
        if (
          ...
          height - dropdownCalculatedStyle.top <
            keyboardHeight + minDropdownHeight
        ) {
          return {
        ...
        if (
          ...
          dropdownCalculatedStyle.bottom < keyboardHeight - minDropdownHeight
        ) {
          return {
            top: height - (keyboardHeight + minDropdownHeight),
            bottom: undefined,
